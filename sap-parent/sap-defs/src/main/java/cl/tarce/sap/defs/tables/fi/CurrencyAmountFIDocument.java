...
public class CurrencyAmountFIDocument {
	...
	@BapiParameter(name = "DISC_AMT", type = ParameterType.SCALAR)
	private Double discountDocumentCurrency;
	
	@BapiParameter(name = "TAX_AMT", type = ParameterType.SCALAR)
	private Double taxAmountPostCurrency;
	...
	public Double getDiscountDocumentCurrency() {
		return discountDocumentCurrency;
	}

	public void setDiscountDocumentCurrency(Double discountDocumentCurrency) {
		this.discountDocumentCurrency = discountDocumentCurrency;
	}

	public Double getTaxAmountPostCurrency() {
		return taxAmountPostCurrency;
	}

	public void setTaxAmountPostCurrency(Double taxAmountPostCurrency) {
		this.taxAmountPostCurrency = taxAmountPostCurrency;
	}
